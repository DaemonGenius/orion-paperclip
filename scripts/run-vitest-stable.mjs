...
const additionalSerializedServerTests = new Set([
  ...
  "server/src/__tests__/heartbeat-task-liveness-escalation.test.ts",
  ...
  "server/src/__tests__/tasks-checkout-wakeup.test.ts",
  "server/src/__tests__/tasks-service.test.ts",
