...
export const heartbeatRuns = pgTable(
  "heartbeat_runs",
  {
    ...
    taskCommentStatus: text("task_comment_status").notNull().default("not_applicable"),
    taskCommentSatisfiedByCommentId: uuid("task_comment_satisfied_by_comment_id"),
    taskCommentRetryQueuedAt: timestamp("task_comment_retry_queued_at", { withTimezone: true }),
