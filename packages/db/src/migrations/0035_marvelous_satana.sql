...
--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN "project_workspace_id" uuid;--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN "execution_workspace_id" uuid;--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN "execution_workspace_preference" text;--> statement-breakpoint
...
ALTER TABLE "execution_workspaces" ADD CONSTRAINT "execution_workspaces_source_task_id_tasks_id_fk" FOREIGN KEY ("source_task_id") REFERENCES "public"."tasks"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "task_work_products" ADD CONSTRAINT "task_work_products_execution_workspace_id_execution_workspaces_id_fk" FOREIGN KEY ("execution_workspace_id") REFERENCES "public"."execution_workspaces"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_work_products" ADD CONSTRAINT "task_work_products_runtime_service_id_workspace_runtime_services_id_fk" FOREIGN KEY ("runtime_service_id") REFERENCES "public"."workspace_runtime_services"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_work_products" ADD CONSTRAINT "task_work_products_created_by_run_id_heartbeat_runs_id_fk" FOREIGN KEY ("created_by_run_id") REFERENCES "public"."heartbeat_runs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "execution_workspaces_company_source_task_idx" ON "execution_workspaces" USING btree ("company_id","source_task_id");--> statement-breakpoint
...
CREATE INDEX "task_work_products_company_execution_workspace_type_idx" ON "task_work_products" USING btree ("company_id","execution_workspace_id","type");--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_execution_workspace_id_execution_workspaces_id_fk" FOREIGN KEY ("execution_workspace_id") REFERENCES "public"."execution_workspaces"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "tasks_company_execution_workspace_idx" ON "tasks" USING btree ("company_id","execution_workspace_id");--> statement-breakpoint
