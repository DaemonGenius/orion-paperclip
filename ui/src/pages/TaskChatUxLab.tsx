...
import {
  taskChatUxAgentMap,
  taskChatUxFeedbackVotes,
  taskChatUxLinkedRuns,
  taskChatUxLiveComments,
  taskChatUxLiveEvents,
  taskChatUxLiveRuns,
  taskChatUxMentions,
  taskChatUxReassignOptions,
  taskChatUxReviewComments,
  taskChatUxReviewEvents,
  taskChatUxSubmittingComments,
  taskChatUxTranscriptsByRunId,
} from "../fixtures/taskChatUxFixtures";
...
export function TaskChatUxLab() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <TaskChatThread
          comments={taskChatUxLiveComments}
          linkedRuns={taskChatUxLinkedRuns.slice(0, 1)}
          timelineEvents={taskChatUxLiveEvents}
          liveRuns={taskChatUxLiveRuns}
          taskStatus="todo"
          agentMap={taskChatUxAgentMap}
          currentUserId="user-1"
          onAdd={noop}
          onVote={noop}
          onCancelRun={noop}
          onInterruptQueued={noop}
          draftKey="task-chat-ux-lab-primary"
          enableReassign
          reassignOptions={taskChatUxReassignOptions}
          currentAssigneeValue="agent:agent-1"
          suggestedAssigneeValue="agent:agent-2"
          mentions={taskChatUxMentions}
          showComposer={showComposer}
          enableLiveTranscriptPolling={false}
          transcriptsByRunId={taskChatUxTranscriptsByRunId}
          hasOutputForRun={(runId) => taskChatUxTranscriptsByRunId.has(runId)}
        />
      </LabSection>
      ...
      >
        <TaskChatThread
          comments={taskChatUxSubmittingComments}
          linkedRuns={[]}
          timelineEvents={[]}
          ...
          currentUserId="user-1"
          onAdd={noop}
          draftKey="task-chat-ux-lab-submitting"
          showComposer={false}
          enableLiveTranscriptPolling={false}
        />
      </LabSection>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        >
          <TaskChatThread
            comments={taskChatUxReviewComments}
            linkedRuns={taskChatUxLinkedRuns.slice(1)}
            timelineEvents={taskChatUxReviewEvents}
            feedbackVotes={taskChatUxFeedbackVotes}
            ...
            onAdd={noop}
            onVote={noop}
            draftKey="task-chat-ux-lab-review"
            showComposer={false}
            enableLiveTranscriptPolling={false}
          />
        </LabSection>
        ...
        <div className="space-y-6">
          ...
          >
            <TaskChatThread
              ...
              draftKey="task-chat-ux-lab-empty"
              enableLiveTranscriptPolling={false}
            />
          </LabSection>
