      ...
      <Section title="Status System">
        ...
        <SubSection title="TaskReferencePill">
          <p className="text-xs text-muted-foreground">
            ...
            Pass <code className="font-mono">status</code> to show the target task&apos;s state at a glance.
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <TaskReferencePill task={{ id: "demo-2", identifier: "PAP-456", title: "With in_progress status", status: "in_progress" }} />
            <TaskReferencePill task={{ id: "demo-3", identifier: "PAP-789", title: "Done status", status: "done" }} />
            <TaskReferencePill task={{ id: "demo-4", identifier: "PAP-101", title: "Blocked status", status: "blocked" }} />
            <TaskReferencePill strikethrough task={{ id: "demo-5", identifier: "PAP-202", title: "Removed (strikethrough)", status: "todo" }} />
          </div>
        </SubSection>
      </Section>
