...
export function MetricCard({ icon: Icon, value, label, description, to, onClick }: MetricCardProps) {
  ...
  const inner = (
    <div className={`vnt-glass-surface h-full rounded-lg border border-transparent px-4 py-4 transition-[background-color,border-color,box-shadow] sm:px-5 sm:py-5${isClickable ? " cursor-pointer hover:bg-accent/50 hover:border-ring/40" : ""}`}>
