    ...
    <div ref={setNodeRef} style={style} {...attributes} {...listeners} className="overflow-visible">
      <Tooltip delayDuration={300}>
        <TooltipTrigger asChild>
          <a
            href={`/${company.taskPrefix}/dashboard`}
            onClick={(e) => {
              if (isDragging) {
                e.preventDefault();
                return;
...
export function CompanyRail() {
  ...
  return (
    <div className="vnt-glass-surface flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
