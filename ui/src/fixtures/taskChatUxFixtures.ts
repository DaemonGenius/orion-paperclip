...
export const taskChatUxAgentMap = new Map<string, Agent>([
  [primaryAgent.id, primaryAgent],
  [reviewAgent.id, reviewAgent],
]);

export const taskChatUxMentions: MentionOption[] = [
  {
    id: "mention-agent-1",
...
export const taskChatUxReassignOptions: InlineEntityOption[] = [
  {
...
export const taskChatUxLiveComments: TaskChatComment[] = [
  createComment({
...
export const taskChatUxLiveEvents: TaskTimelineEvent[] = [
  {
    id: "event-live-1",
...
export const taskChatUxLiveRuns: LiveRunForTask[] = [
  {
    id: "run-live-1",
    status: "running",
...
export const taskChatUxLinkedRuns: TaskChatLinkedRun[] = [
  {
    runId: "run-history-1",
    status: "succeeded",
    agentId: primaryAgent.id,
...
export const taskChatUxTranscriptsByRunId = new Map<string, readonly TaskChatTranscriptEntry[]>([
  [
    "run-history-1",
    [
      {
  ...
  [
    ...
    [
      ...
      },
      {
        ...
        input: { file: "ui/src/components/TaskChatThread.tsx", action: "remove scroll pane" },
      },
      {
        kind: "tool_result",
...
export const taskChatUxSubmittingComments: TaskChatComment[] = [
  createComment({
...
export const taskChatUxReviewComments: TaskChatComment[] = [
  createComment({
...
export const taskChatUxReviewEvents: TaskTimelineEvent[] = [
  {
    id: "event-review-1",
...
export const taskChatUxFeedbackVotes: FeedbackVote[] = [
  {
    id: "feedback-1",
    companyId: "company-ux",
    taskId: "task-ux",
