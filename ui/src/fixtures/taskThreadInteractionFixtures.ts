...
export const taskThreadInteractionFixtureMeta = {
  companyId: "company-storybook",
  projectId: "project-board-ui",
  taskId: "task-thread-interactions",
  currentUserId: "user-board",
} as const;

function createComment(overrides: Partial<TaskChatComment>): TaskChatComment {
  ...
  return {
    ...
    taskId: taskThreadInteractionFixtureMeta.taskId,
    authorAgentId: null,
    authorUserId: taskThreadInteractionFixtureMeta.currentUserId,
    body: "",
    createdAt,
...
function createSuggestTasksInteraction(
  ...
  return {
    ...
    taskId: taskThreadInteractionFixtureMeta.taskId,
    kind: "suggest_tasks",
    title: "Suggested task tree for the first interaction pass",
    summary:
      ...
      tasks: [
        {
          ...
          title: "Prototype task-thread interaction cards",
          description:
            "Build render-only cards that sit in the task feed and show suggested tasks before anything is persisted.",
          priority: "high",
...
export const acceptedSuggestedTasksInteraction = createSuggestTasksInteraction({
  ...
  status: "accepted",
  resolvedByUserId: taskThreadInteractionFixtureMeta.currentUserId,
  ...
  result: {
    ...
    createdTasks: [
      ...
      },
      {
        ...
        identifier: "PAP-1714",
        title: "Add Storybook coverage for acceptance and rejection states",
        parentTaskId: "task-created-1",
        parentIdentifier: "PAP-1713",
      },
      {
        clientKey: "child-mixed-thread",
        taskId: "task-created-3",
        identifier: "PAP-1715",
        title: "Prototype the mixed thread feed",
        parentTaskId: "task-created-1",
        parentIdentifier: "PAP-1713",
      ...
      {
        clientKey: "hidden-follow-up",
        taskId: "task-created-4",
        identifier: "PAP-1716",
        title: "Follow-up polish on spacing and answered summaries",
        parentTaskId: "task-created-3",
...
export const taskThreadInteractionComments: TaskChatComment[] = [
  createComment({
    id: "comment-thread-board",
    body: "Pressure-test first-class task-thread interactions before we touch persistence. I want to see the cards in the real feed, not in a disconnected mock.",
  ...
  createComment({
    ...
    authorUserId: null,
    body: "I found the existing task chat surface and I am adding prototype-only interaction records so the Storybook review can happen before persistence work.",
...
export const taskThreadInteractionEvents: TaskTimelineEvent[] = [
  {
    id: "event-thread-checkout",
    createdAt: new Date("2026-04-20T14:01:00.000Z"),
    actorType: "user",
    actorId: taskThreadInteractionFixtureMeta.currentUserId,
    statusChange: {
      from: "todo",
      to: "in_progress",
    },
...
export const taskThreadInteractionLiveRuns: LiveRunForTask[] = [
  {
    id: "run-thread-live",
    status: "running",
...
export const taskThreadInteractionTranscriptsByRunId = new Map<
  string,
  readonly TaskChatTranscriptEntry[]
>([
  [
    "run-thread-live",
    [
      {
        ...
        text: "Wiring the prototype interaction cards into the same task feed that already renders comments and live runs.",
      },
      {
        kind: "thinking",
...
export const mixedTaskThreadInteractions = [
