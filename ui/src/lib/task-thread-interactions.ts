...
export function isTaskThreadInteraction(
  value: unknown,
): value is TaskThreadInteraction {
  if (!value || typeof value !== "object") return false;
  const candidate = value as Partial<TaskThreadInteraction>;
...
export function buildTaskThreadInteractionSummary(
