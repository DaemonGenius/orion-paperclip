...
// TODO(task-worktree-support): re-enable this UI once the workflow is ready to ship.
const SHOW_EXPERIMENTAL_TASK_WORKTREE_UI = false;
...
export function RuntimeServicesJsonField({
  ...
  if (!SHOW_EXPERIMENTAL_TASK_WORKTREE_UI) {
    return null;
  }
